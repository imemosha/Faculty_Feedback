...
if (isset($_POST['Add'])) {
  ...
  //form validation for text box
    if (isset($_POST['designation']) && !empty($_POST['designation'])) {
      ...
      $err['designation'] =  "Write your description here";
    }
        ...
        <form method="post" enctype="multipart/form-data" >
          <fieldset>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Enter your name"><!-- here use 'value' if the main purpose of the form is editing-->
         ...
         <?php } ?> 
          ...
          <br/>
           <fieldset>
              ...
              <div class="form-group">
                  <label for="designation">Designataion</label>
                  <input type="text" class="form-control" name="designation" id="designation" aria-describedby="helpId" placeholder="Enter here">
              </div>
              <?php if (isset($err['designation'])) { ?>
             <span class="text-danger"><?php echo $err['designation']; ?></span>
           <?php } ?>
              <div class="form-row">
              	<div class="form-group col-md-6">                
           ...
           <?php } ?>
            ...
            <hr>
             <div class="form-group" style="padding-left: 4vw;padding-right: 4vw">
              <input type="submit" class="col-md-6 smallwidth infotrans btn-outline-secondary p-3 btn btn-dark text-dark" value="Add Faculty" name="Add">
              <input class="col-md-6 btn btn-light smallwidth darktrans  btn-outline-secondary p-3 text-dark" type="reset" name="clearBtn" value="Clear Form">
            </div>
