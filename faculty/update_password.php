	...
	<div class="col-md-10">
      ...
      <div class="card-body" style="background-color: #f1f1f1">
          ...
          <form method="post" enctype="multipart/form-data">
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" id="oldpassword" aria-describedby="helpId" placeholder="********">
           ...
           <?php } ?>
              ...
              <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password" id="newpassword" aria-describedby="helpId" placeholder="********">
          ...
          <div class="form-group" style="padding-left: 4vw;padding-right: 4vw">
              <input type="submit" class="col-md-6 smallwidth infotrans btn-outline-secondary p-3 btn btn-dark text-dark" value="Update Password" name="Password" id="Password">
